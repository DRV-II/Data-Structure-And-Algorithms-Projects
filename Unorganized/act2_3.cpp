...
vector<vector<string>> ordenBurbuja(vector<vector<string>> a)
{
  ...
  for (int i = 0; i < n; i++)
  {
    ...
    {
      if (stol(a[j][3]) > stol(a[j + 1][3])) //se usa el id que creamos para buscar el valor
      {
...
int main()
{
  ...
  */
  ...
  //ectorConvertido = convertirHoras(vectorConvertido);
  ...
  */
  ...
  cout<<vectorOrdenado[0][3]<<endl;
  cout<<vectorOrdenado[1][3]<<endl;
  cout<<vectorOrdenado[2][3]<<endl;
